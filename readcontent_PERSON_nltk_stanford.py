...
stanford_classifier = 'D:\StanfordParser\stanford-ner-2018-10-16\classifiers\english.all.3class.distsim.crf.ser.gz'
stanford_ner_path = 'D:\StanfordParser\stanford-ner-2018-10-16\stanford-ner.jar'
...
class ReadContent:
    def __init__(self,path):
        ...
        self.st = StanfordNERTagger(stanford_classifier, stanford_ner_path, encoding='utf-8') # stanford tagger
    ...
    def parse(self,start=None,end=None):
        ...
        # get stats
        info = self.st.tag(self.document)
        self.nouns = [en[0] for en in info if en[1] == 'PERSON']  # extract all member like (NAME, "PERSON")
...
#    stats = get_noun_stats(sample_text,500)
#    for i in stats:
#        print(i)
